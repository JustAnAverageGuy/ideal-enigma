...
HANDLE="AFDEI"
PASSWORD="the password to my testing account"
...
def main():
    ...
    # with open(code) as f: cod = f.read()
    ...
    # problem_index = matches["problem_index"] or matches["problem_index_2c"]

    submit_code("171", "H", f"hehe {datetime.datetime.now()}", "26")
